...
module.exports = function(grunt) {
  ...
  var opts = {
    ...
    'http-server': {
      frontend: {
        root: 'app',
        port: url.parse(backendOptions.GTP_FRONTEND_URL).port || process.env.PORT || 11000,
        host: url.parse(backendOptions.GTP_FRONTEND_URL).hostname || process.env.IP || '0.0.0.0',
        cache: -1,
        showDir: true,
        autoIndex: false,
